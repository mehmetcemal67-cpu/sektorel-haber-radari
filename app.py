...
# ============================================================
# V129 — Arka plan görseli kod içine gömülmez; uygulama klasöründeki
# background.png dosyası çalışma anında okunur. Böylece Python dosyası
# gereksiz biçimde milyonlarca karakter büyümez.
def _v129_load_background_data():
    try:
        import base64
        bg_path = Path(__file__).resolve().with_name("background.png")
...
_V125_BG_DATA = _v129_load_background_data()
